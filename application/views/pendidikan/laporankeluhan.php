            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body col-lg-12">
                        <a class="btn btn-success mb-3" href="<?php echo base_url("pendidikan/export"); ?>">Export ke Excel</a>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $pdv ?></td>
                                        <td>
                                            <a href="<?= base_url();  ?>pendidikan/detailpendidikan/<?= $pd['id_proposal']; ?>" class="btn btn-success"><span class="fa fa-eye"> Detail</a>

                                            <a class="btn btn-warning" href="<?php echo base_url("pendidikan/cetak/"); ?><?= $pd['id_proposal']; ?>">Cetak PDF</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
