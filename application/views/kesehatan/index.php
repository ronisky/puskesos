    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-hover text-center">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php foreach ($kesehatan as $ks) : ?>
                        <tr>
                            <th scope="row"><?= $i;  ?></th>
                            <td><?= $ks['nama']; ?></td>
                            <td><?= $ks['nama_proposal']; ?></td>
                            <td><?= $ks['nis']; ?></td>
                            <td><?= $ks['alamat']; ?></td>
                            <td>
                                <a href="<?= base_url('assets/verivikasi/gambar/') . $ks['foto']; ?>" class="venobox">
                                    <img src="<?= base_url('assets/verivikasi/gambar/') . $ks['foto']; ?>" class="img-fluid m-b-12">
                            </td>
                            <td>
                                <a href="<?= base_url('kesehatan/ubahkesehatan/');  ?><?= $ks['id_proposal']; ?>" class="btn btn-success"><span class="fa fa-edit"> Edit</a>

                                <a href="<?= base_url(); ?>administrator/hapusKesehatan/<?= $ks['id_proposal']; ?>" class="btn btn-danger tombol-hapus"><span class="fa fa-trash"> Hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input id="nama_proposal" name="nama_proposal" value="Kesehatan" class="form-control" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="nama_organisasi" name="nama_organisasi" value="Bidang Kesehatan" hidden>
                    <div class="form-group">
                        <textarea type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Lengkap"></textarea>
                    </div>

                    <div class="form-group">
                        <select type="text" class="form-control" id="keperluan" name="keperluan" placeholder="Keperluan">
                            <option value="Jampersal">Jampersal</option>
                            <option value="Rumah Sakit">Rumah Sakit</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <textarea type="text" class="form-control" id="tujuan" name="tujuan" placeholder="Tujuan"></textarea>
                    </div>
                    <div class="form-group">
