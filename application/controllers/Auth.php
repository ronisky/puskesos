...
class Auth extends CI_Controller
{
    ...
    public function forgotpassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Halaman Lupa Kata Sandi';
            $this->load->view('templates/auth_header', $data);
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Tolong periksa email anda untuk mengatur ulang kata sandi</div>');
                redirect('auth/forgotpassword');
            } else {
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Email belum diregistrasi atau belum diaktivasi</div>');
                redirect('auth/forgotpassword');
            }
        }
    }
    public function resetPassword()
    {
        ...
        if ($user) {
            ...
            if ($user_token) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Mengatur ulang kata sandi gagal! Token salah.</div>');
                redirect('auth');
            }
        } else {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Mengatur ulang kata sandi gagal! Email salah.</div>');
            redirect('auth');
        }
    }
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Kata sandi berhasil diubah! Silahkan login</div>');
            redirect('auth');
        }
    }
}
